const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/js/Dashboard-g_mbnw4m.js","assets/js/leaflet-vendor-HKOewaEh.js","assets/js/react-vendor-D_QSeeZk.js","assets/css/Dashboard-DfT0CDWW.css"])))=>i.map(i=>d[i]);
...
import { r as reactExports, R as React } from "./leaflet-vendor-HKOewaEh.js";
(function polyfill() {
...
const Dashboard = reactExports.lazy(() => __vitePreload(() => import("./Dashboard-g_mbnw4m.js").then((n) => n.D), true ? __vite__mapDeps([0,1,2,3]) : void 0));
const App = () => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "App", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { style: { padding: "2rem", textAlign: "center" }, children: [
        ...
        showDashboard && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "🚀 Step 5: Full Dashboard with Advanced Features" }),
