...
function requirePapaparse_min() {
  ...
  (function(module, exports) {
    ((e2, t) => {
      ...
      var d, s = !n.document && !!n.postMessage, a2 = n.IS_PAPA_WORKER || false, o = {}, h = 0, v = {};
      function u2(e2) {
        this._handle = null, this._finished = false, this._completed = false, this._halted = false, this._input = null, this._baseIndex = 0, this._partialLine = "", this._rowCount = 0, this._start = 0, this._nextChunk = null, this.isFirstChunk = true, this._completeResults = { data: [], errors: [], meta: {} }, function(e3) {
          ...
          if (!this._handle.paused() && !this._handle.aborted()) {
            ...
            if (a2) n.postMessage({ results: r2, workerId: v.WORKER_ID, finished: i2 });
          ...
          U2(this._config.error) ? this._config.error(e3) : a2 && this._config.error && n.postMessage({ workerId: v.WORKER_ID, error: e3, finished: false });
        };
      }
      function f2(e2) {
        var r2;
        (e2 = e2 || {}).chunkSize || (e2.chunkSize = v.RemoteChunkSize), u2.call(this, e2), this._nextChunk = s ? function() {
      ...
      function l(e2) {
        (e2 = e2 || {}).chunkSize || (e2.chunkSize = v.LocalChunkSize), u2.call(this, e2);
        var i2, r2, n2 = "undefined" != typeof FileReader;
        this.stream = function(e3) {
          this._input = e3, r2 = e3.slice || e3.webkitSlice || e3.mozSlice, n2 ? ((i2 = new FileReader()).onload = y(this._chunkLoaded, this), i2.onerror = y(this._chunkError, this)) : i2 = new FileReaderSync(), this._nextChunk();
      ...
      function i(m2) {
        var n2, s2, a3, t, o2 = Math.pow(2, 53), h2 = -o2, u3 = /^\s*-?(\d+\.?|\.\d+|\d+\.\d+)([eE][-+]?\d+)?\s*$/, d2 = /^((\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d\.\d+([+-][0-2]\d:[0-5]\d|Z))|(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d:[0-5]\d([+-][0-2]\d:[0-5]\d|Z))|(\d{4}-[01]\d-[0-3]\dT[0-2]\d:[0-5]\d([+-][0-2]\d:[0-5]\d|Z)))$/, i2 = this, r2 = 0, f3 = 0, l2 = false, e2 = false, c2 = [], p2 = { data: [], errors: [], meta: {} };
        function y2(e3) {
          return "greedy" === m2.skipEmptyLines ? "" === e3.join("").trim() : 1 === e3.length && 0 === e3[0].length;
        }
        function g2() {
          if (p2 && a3 && (k("Delimiter", "UndetectableDelimiter", "Unable to auto-detect delimiting character; defaulted to '" + v.DefaultDelimiter + "'"), a3 = false), m2.skipEmptyLines && (p2.data = p2.data.filter(function(e4) {
            return !y2(e4);
          })), _2()) {
            let t2 = function(e4, t3) {
              U2(m2.transformHeader) && (e4 = m2.transformHeader(e4, t3)), c2.push(e4);
            };
          ...
          function i3(e4, t2) {
            for (var i4 = m2.header ? {} : [], r4 = 0; r4 < e4.length; r4++) {
              var n3 = r4, s3 = e4[r4], s3 = ((e5, t3) => ((e6) => (m2.dynamicTypingFunction && void 0 === m2.dynamicTyping[e6] && (m2.dynamicTyping[e6] = m2.dynamicTypingFunction(e6)), true === (m2.dynamicTyping[e6] || m2.dynamicTyping)))(e5) ? "true" === t3 || "TRUE" === t3 || "false" !== t3 && "FALSE" !== t3 && (((e6) => {
                if (u3.test(e6)) {
                  e6 = parseFloat(e6);
            ...
            return m2.header && (r4 > c2.length ? k("FieldMismatch", "TooManyFields", "Too many fields: expected " + c2.length + " fields but parsed " + r4, f3 + t2) : r4 < c2.length && k("FieldMismatch", "TooFewFields", "Too few fields: expected " + c2.length + " fields but parsed " + r4, f3 + t2)), i4;
          }
          var r3;
        ...
        U2(m2.step) && (t = m2.step, m2.step = function(e3) {
          ...
          var r3 = m2.quoteChar || '"', r3 = (m2.newline || (m2.newline = this.guessLineEndings(e3, r3)), a3 = false, m2.delimiter ? U2(m2.delimiter) && (m2.delimiter = m2.delimiter(e3), p2.meta.delimiter = m2.delimiter) : ((r3 = ((e4, t3, i4, r4, n3) => {
            var s3, a4, o3, h3;
            n3 = n3 || [",", "	", "|", ";", v.RECORD_SEP, v.UNIT_SEP];
            for (var u4 = 0; u4 < n3.length; u4++) {
              for (var d3, f4 = n3[u4], l3 = 0, c3 = 0, p3 = 0, g3 = (o3 = void 0, new E2({ comments: r4, delimiter: f4, newline: t3, preview: 10 }).parse(e4)), _3 = 0; _3 < g3.data.length; _3++) i4 && y2(g3.data[_3]) ? p3++ : (d3 = g3.data[_3].length, c3 += d3, void 0 === o3 ? o3 = d3 : 0 < d3 && (l3 += Math.abs(d3 - o3), o3 = d3));
              0 < g3.data.length && (c3 /= g3.data.length - p3), (void 0 === a4 || l3 <= a4) && (void 0 === h3 || h3 < c3) && 1.99 < c3 && (a4 = l3, s3 = f4, h3 = c3);
            }
            return { successful: !!(m2.delimiter = s3), bestDelimiter: s3 };
          })(e3, m2.newline, m2.skipEmptyLines, m2.comments, m2.delimitersToGuess)).successful ? m2.delimiter = r3.bestDelimiter : (a3 = true, m2.delimiter = v.DefaultDelimiter), p2.meta.delimiter = m2.delimiter), b(m2));
          return m2.preview && m2.header && r3.preview++, n2 = e3, s2 = new E2(r3), p2 = s2.parse(n2, t2, i3), g2(), l2 ? { meta: { paused: true } } : p2 || { meta: { paused: false } };
          ...
          e2 = true, s2.abort(), p2.meta.aborted = true, U2(m2.complete) && m2.complete(p2), n2 = "";
      ...
      function E2(C) {
        var S = (C = C || {}).delimiter, O = C.newline, x = C.comments, I = C.step, A2 = C.preview, T2 = C.fastMode, D = null, L2 = false, F2 = null == C.quoteChar ? '"' : C.quoteChar, j = F2;
        if (void 0 !== C.escapeChar && (j = C.escapeChar), ("string" != typeof S || -1 < v.BAD_DELIMITERS.indexOf(S)) && (S = ","), x === S) throw new Error("Comment character same as delimiter");
        true === x ? x = "#" : ("string" != typeof x || -1 < v.BAD_DELIMITERS.indexOf(x)) && (x = false), "\n" !== O && "\r" !== O && "\r\n" !== O && (O = "\n");
        var z2 = 0, M = false;
        this.parse = function(i2, t, r2) {
          if ("string" != typeof i2) throw new Error("Input must be a string");
          var n2 = i2.length, e2 = S.length, s2 = O.length, a3 = x.length, o2 = U2(I), h2 = [], u3 = [], d2 = [], f3 = z2 = 0;
          if (!i2) return w();
          if (T2 || false !== T2 && -1 === i2.indexOf(F2)) {
            for (var l2 = i2.split(O), c2 = 0; c2 < l2.length; c2++) {
              ...
              if (!x || d2.substring(0, a3) !== x) {
                ...
                if (A2 && A2 <= c2) return h2 = h2.slice(0, A2), w(true);
              }
            }
            return w();
          }
          for (var p2 = i2.indexOf(S, z2), g2 = i2.indexOf(O, z2), _2 = new RegExp(P(j) + P(F2), "g"), m2 = i2.indexOf(F2, z2); ; ) if (i2[z2] === F2) for (m2 = z2, z2++; ; ) {
            if (-1 === (m2 = i2.indexOf(F2, m2 + 1))) return r2 || u3.push({ type: "Quotes", code: "MissingQuotes", message: "Quoted field unterminated", row: h2.length, index: z2 }), E3();
            if (m2 === n2 - 1) return E3(i2.substring(z2, m2).replace(_2, F2));
            if (F2 === j && i2[m2 + 1] === j) m2++;
            else if (F2 === j || 0 === m2 || i2[m2 - 1] !== j) {
              -1 !== p2 && p2 < m2 + 1 && (p2 = i2.indexOf(S, m2 + 1));
              var y2 = v2(-1 === (g2 = -1 !== g2 && g2 < m2 + 1 ? i2.indexOf(O, m2 + 1) : g2) ? p2 : Math.min(p2, g2));
              if (i2.substr(m2 + 1 + y2, e2) === S) {
                d2.push(i2.substring(z2, m2).replace(_2, F2)), i2[z2 = m2 + 1 + y2 + e2] !== F2 && (m2 = i2.indexOf(F2, z2)), p2 = i2.indexOf(S, z2), g2 = i2.indexOf(O, z2);
                break;
              }
              y2 = v2(g2);
              if (i2.substring(m2 + 1 + y2, m2 + 1 + y2 + s2) === O) {
                if (d2.push(i2.substring(z2, m2).replace(_2, F2)), b2(m2 + 1 + y2 + s2), p2 = i2.indexOf(S, z2), m2 = i2.indexOf(F2, z2), o2 && (R(), M)) return w();
                if (A2 && h2.length >= A2) return w(true);
                break;
              }
              u3.push({ type: "Quotes", code: "InvalidQuotes", message: "Trailing quote on quoted field is malformed", row: h2.length, index: z2 }), m2++;
            }
          }
          else if (x && 0 === d2.length && i2.substring(z2, z2 + a3) === x) {
            if (-1 === g2) return w();
            z2 = g2 + s2, g2 = i2.indexOf(O, z2), p2 = i2.indexOf(S, z2);
          } else if (-1 !== p2 && (p2 < g2 || -1 === g2)) d2.push(i2.substring(z2, p2)), z2 = p2 + e2, p2 = i2.indexOf(S, z2);
          else {
            if (-1 === g2) break;
            if (d2.push(i2.substring(z2, g2)), b2(g2 + s2), o2 && (R(), M)) return w();
            if (A2 && h2.length >= A2) return w(true);
          }
          return E3();
          function k(e3) {
          ...
          function E3(e3) {
            return r2 || (void 0 === e3 && (e3 = i2.substring(z2)), d2.push(e3), z2 = n2, k(d2), o2 && R()), w();
          }
          function b2(e3) {
            z2 = e3, k(d2), d2 = [], g2 = i2.indexOf(O, z2);
          }
          function w(e3) {
            if (C.header && !t && h2.length && !L2) {
              var s3 = h2[0], a4 = /* @__PURE__ */ Object.create(null), o3 = new Set(s3);
              let n3 = false;
              for (let r3 = 0; r3 < s3.length; r3++) {
                let i3 = s3[r3];
                if (a4[i3 = U2(C.transformHeader) ? C.transformHeader(i3, r3) : i3]) {
                  let e4, t2 = a4[i3];
                  for (; e4 = i3 + "_" + t2, t2++, o3.has(e4); ) ;
                  o3.add(e4), s3[r3] = e4, a4[i3]++, n3 = true, (D = null === D ? {} : D)[e4] = i3;
                } else a4[i3] = 1, s3[r3] = i3;
                o3.add(i3);
              }
              n3 && console.warn("Duplicate headers found and renamed."), L2 = true;
            }
            return { data: h2, errors: u3, meta: { delimiter: S, linebreak: O, aborted: M, truncated: !!e3, cursor: f3 + (t || 0), renamedHeaders: D } };
          }
          function R() {
            I(w()), h2 = [], u3 = [];
          }
      ...
      function g(e2) {
        var t = e2.data, i2 = o[t.workerId], r2 = false;
      ...
      function _(e2, t) {
        var i2 = o[e2];
        U2(i2.userComplete) && i2.userComplete(t), i2.terminate(), delete o[e2];
      }
      function m() {
      ...
      return v.parse = function(e2, t) {
        ...
        })()).userStep = t.step, i2.userChunk = t.chunk, i2.userComplete = t.complete, i2.userError = t.error, t.step = U2(t.step), t.chunk = U2(t.chunk), t.complete = U2(t.complete), t.error = U2(t.error), delete t.worker, i2.postMessage({ input: e2, config: t, workerId: i2.id });
      }, v.unparse = function(e2, t) {
        var n2 = false, _2 = true, m2 = ",", y2 = "\r\n", s2 = '"', a3 = s2 + s2, i2 = false, r2 = null, o2 = false, h2 = ((() => {
          if ("object" == typeof t) {
            ...
            void 0 !== t.escapeChar && (a3 = t.escapeChar + s2), t.escapeFormulae instanceof RegExp ? o2 = t.escapeFormulae : "boolean" == typeof t.escapeFormulae && t.escapeFormulae && (o2 = /^[=+\-@\t\r].*$/);
          }
        })(), new RegExp(P(s2), "g"));
        "string" == typeof e2 && (e2 = JSON.parse(e2));
        if (Array.isArray(e2)) {
          if (!e2.length || Array.isArray(e2[0])) return u3(null, e2, i2);
          if ("object" == typeof e2[0]) return u3(r2 || Object.keys(e2[0]), e2, i2);
        ...
        function u3(e3, t2, i3) {
          ...
          if (n3 && _2) {
            for (var a4 = 0; a4 < e3.length; a4++) 0 < a4 && (r3 += m2), r3 += k(e3[a4], a4);
            0 < t2.length && (r3 += y2);
          }
          for (var o3 = 0; o3 < t2.length; o3++) {
            var h3 = (n3 ? e3 : t2[o3]).length, u4 = false, d2 = n3 ? 0 === Object.keys(t2[o3]).length : 0 === t2[o3].length;
            if (i3 && !n3 && (u4 = "greedy" === i3 ? "" === t2[o3].join("").trim() : 1 === t2[o3].length && 0 === t2[o3][0].length), "greedy" === i3 && n3) {
        ...
        function k(e3, t2) {
          var i3, r3;
          return null == e3 ? "" : e3.constructor === Date ? JSON.stringify(e3).slice(1, 25) : (r3 = false, o2 && "string" == typeof e3 && o2.test(e3) && (e3 = "'" + e3, r3 = true), i3 = e3.toString().replace(h2, a3), (r3 = r3 || true === n2 || "function" == typeof n2 && n2(e3, t2) || Array.isArray(n2) && n2[t2] || ((e4, t3) => {
      ...
      }, v.RECORD_SEP = String.fromCharCode(30), v.UNIT_SEP = String.fromCharCode(31), v.BYTE_ORDER_MARK = "\uFEFF", v.BAD_DELIMITERS = ["\r", "\n", '"', v.BYTE_ORDER_MARK], v.WORKERS_SUPPORTED = !s && !!n.Worker, v.NODE_STREAM_INPUT = 1, v.LocalChunkSize = 10485760, v.RemoteChunkSize = 5242880, v.DefaultDelimiter = ",", v.Parser = E2, v.ParserHandle = i, v.NetworkStreamer = f2, v.FileStreamer = l, v.StringStreamer = c, v.ReadableStreamStreamer = p, n.jQuery && ((d = n.jQuery).fn.parse = function(o2) {
        var i2 = o2.config || {}, h2 = [];
        ...
        function e2() {
          if (0 === h2.length) U2(o2.complete) && o2.complete();
            ...
            if (U2(o2.before)) {
              ...
              if ("object" == typeof s2) {
                if ("abort" === s2.action) return e3 = "AbortError", t = n2.file, i3 = n2.inputElem, r2 = s2.reason, void (U2(o2.error) && o2.error({ name: e3 }, t, i3, r2));
            ...
            n2.instanceConfig.complete = function(e4) {
              U2(a3) && a3(e4, n2.file, n2.inputElem), u3();
      ...
      }), a2 && (n.onmessage = function(e2) {
        e2 = e2.data;
        void 0 === v.WORKER_ID && e2 && (v.WORKER_ID = e2.workerId);
        "string" == typeof e2.input ? n.postMessage({ workerId: v.WORKER_ID, results: v.parse(e2.input, e2.config), finished: true }) : (n.File && e2.input instanceof File || e2.input instanceof Object) && (e2 = v.parse(e2.input, e2.config)) && n.postMessage({ workerId: v.WORKER_ID, results: e2, finished: true });
      }), (f2.prototype = Object.create(u2.prototype)).constructor = f2, (l.prototype = Object.create(u2.prototype)).constructor = l, (c.prototype = Object.create(c.prototype)).constructor = c, (p.prototype = Object.create(u2.prototype)).constructor = p, v;
    });
  })(papaparse_min$1);
