...
class KnowledgeGraphService {
  ...
  buildKnowledgeGraph(query, maxDocuments = 50, sources = "lexml") {
  ...
  extractEntities(query, maxDocuments = 10) {
    return __async$1(this, null, function* () {
  ...
  searchNodes(query, nodeType, limit = 20) {
    return __async$1(this, null, function* () {
  ...
  getSubgraph(centerNode, radius = 2, maxNodes = 50) {
    return __async$1(this, null, function* () {
...
const KnowledgeGraphViewer = ({
  ...
  const buildGraph = (searchQuery) => __async(null, null, function* () {
    if (!searchQuery.trim()) {
    ...
    setError(null);
    try {
      const response = yield knowledgeGraphService.buildKnowledgeGraph(searchQuery, maxDocuments);
  ...
  const renderGraph = (data) => {
    ...
    svg.call(zoom$1);
    const simulation$1 = simulation(data.nodes).force("link", link(data.edges).id((d) => d.id).distance((d) => 100 / Math.sqrt(d.weight))).force("charge", manyBody().strength(-300)).force("center", center(width / 2, height / 2)).force("collision", collide().radius((d) => Math.sqrt(d.size) + 5));
    simulationRef.current = simulation$1;
    svg.append("defs").selectAll("marker").data(["arrow"]).enter().append("marker").attr("id", "arrow").attr("viewBox", "0 -5 10 10").attr("refX", 15).attr("refY", 0).attr("markerWidth", 6).attr("markerHeight", 6).attr("orient", "auto").append("path").attr("d", "M0,-5L10,0L0,5").attr("fill", "#999");
    const link$1 = g.append("g").attr("class", "links").selectAll("line").data(data.edges).enter().append("line").attr("stroke", "#999").attr("stroke-opacity", 0.6).attr("stroke-width", (d) => Math.sqrt(d.weight) * 2).attr("marker-end", "url(#arrow)");
    const node = g.append("g").attr("class", "nodes").selectAll("circle").data(data.nodes).enter().append("circle").attr("r", (d) => Math.sqrt(d.size)).attr("fill", (d) => nodeColors[d.type] || nodeColors.default).attr("stroke", "#fff").attr("stroke-width", 2).style("cursor", "pointer").call(drag().on("start", dragstarted).on("drag", dragged).on("end", dragended));
    const label = g.append("g").attr("class", "labels").selectAll("text").data(data.nodes).enter().append("text").text((d) => d.name.length > 20 ? d.name.substring(0, 20) + "..." : d.name).attr("font-size", "10px").attr("font-family", "Arial, sans-serif").attr("fill", "#333").attr("text-anchor", "middle").attr("dy", ".35em").style("pointer-events", "none");
  ...
  const filteredNodes = (graphData == null ? void 0 : graphData.nodes.filter((node) => {
    const matchesSearch = !searchTerm || node.name.toLowerCase().includes(searchTerm.toLowerCase());
    const matchesType = !filterType || node.type === filterType;
    return matchesSearch && matchesType;
  })) || [];
  const nodeTypes = [...new Set((graphData == null ? void 0 : graphData.nodes.map((n) => n.type)) || [])];
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "knowledge-graph-viewer", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "graph-controls", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "search-controls", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            ...
            children: loading ? "Building..." : "Build Graph"
          }
        )
      ] }),
      graphData && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "graph-filters", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            ...
            children: [
              ...
              nodeTypes.map((type) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: type, children: type.replace("_", " ").toUpperCase() }, type))
            ]
          }
        )
      ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "graph-container", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "graph-main", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        "svg",
        {
          ref: svgRef,
          width,
      ...
      graphData && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "graph-sidebar", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "graph-statistics", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "Graph Statistics" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat-item", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Nodes:" }),
            " ",
            graphData.statistics.nodes
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat-item", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Edges:" }),
            " ",
            graphData.statistics.edges
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat-item", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Density:" }),
            " ",
            (_a = graphData.statistics.density) == null ? void 0 : _a.toFixed(3)
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "stat-item", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Components:" }),
            " ",
            graphData.statistics.connected_components
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "node-types-legend", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "Node Types" }),
          Object.entries(nodeColors).filter(([key]) => key !== "default").map(([type, color2]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "legend-item", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: type.replace("_", " ").toUpperCase() })
          ] }, type))
        ] }),
        selectedNode && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "selected-node-info", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "Selected Node" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "node-detail", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "node-detail", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Centrality:" }),
            " ",
            selectedNode.centrality.toFixed(3)
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "node-detail", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Documents:" }),
            " ",
            selectedNode.metadata.document_count || 1
          ] })
        ] }),
        filteredNodes.length > 0 && searchTerm && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "filtered-nodes", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { children: [
            "Matching Nodes (",
            filteredNodes.length,
            ")"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "node-list", children: filteredNodes.slice(0, 10).map((node) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              className: "node-item",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      backgroundColor: nodeColors[node.type] || nodeColors.default
                    }
                  }
                ),
...
var KnowledgeGraphViewer_default = KnowledgeGraphViewer;
export {
  KnowledgeGraphViewer_default as default
};
