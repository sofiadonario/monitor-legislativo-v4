...
tryCatch({
  ...
  if (!exists("get_library_documents")) {
    ...
    sample_documents <- data.frame(
      ...
      category = c("Legislação", "Legislação", "Jurisprudência", "Jurisprudência", "Outros", 
                   "Outros", "Doutrina", "Doutrina", "Proposições", "Proposições"),
      ...
      document_type = c("Medida Provisória", "Decreto Federal", "Acórdão TST", "Decisão TJ-SP", "Ato Administrativo",
                       "Portaria", "Artigo Jurídico", "Tese Acadêmica", "Projeto de Lei", "PEC"),
      url = c(
