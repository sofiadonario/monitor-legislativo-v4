...
RUN R -q -e "install.packages(c('pool','shinydashboard','redux','logger','httr2','future.apply','quanteda','spdep','R6','RPostgreSQL','arrow','cachem','cluster','fpc','htmlwidgets','knitr','microbenchmark','optparse','plumber','profvis','stringi','testthat','uuid','yaml','rmarkdown'), repos='https://cloud.r-project.org')"
