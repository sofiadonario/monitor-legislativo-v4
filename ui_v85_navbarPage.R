...
ui <- function(request) {
  ...
  # Use base Shiny's navbarPage instead of bslib's page_navbar
  navbarPage(
    title = "Monitor Legislativo v4",

    # Apply minimal bslib theme WITHOUT page_navbar wrapper
    theme = bs_theme(
      version = 5,
      bg = "#ffffff",
      fg = "#2c3e50",
...
cat("✅ UI definition loaded successfully (v85 - navbarPage bypass)\\n")
